...
public class ScenarioFirst extends Fragment implements View.OnClickListener{
    Button button;
    TextView itemText;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.scenario_fragment1, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
       ...
       /*String[] sliderColor = {
        ...
        //Set size n fillcolor of circle
